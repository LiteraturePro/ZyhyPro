...
public class SideslipListView_news extends ListView {
    ...
    public SideslipListView_news(Context context) {
        super(context);
        init(context);
    }

    public SideslipListView_news(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SideslipListView_news(Context context, AttributeSet attrs, int defStyleAttr) {
