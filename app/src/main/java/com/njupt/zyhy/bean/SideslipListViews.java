 ...
 */
public class SideslipListViews extends ListView {
    ...
    public SideslipListViews(Context context) {
        super(context);
        init(context);
    }

    public SideslipListViews(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SideslipListViews(Context context, AttributeSet attrs, int defStyleAttr) {
